...
<header>
    <div class="navbar bg-primary">
        ...
        <div class="flex-1">
            <a href="index.php" class="btn btn-ghost normal-case text-xl text-white">Umbrella</a>
        </div>
    </div>
</header>


    <div class="form-control flex align-middle">
        <h1 class="mb-10 mt-10 ml-10 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-10xl lg:text-6xl dark:text-white">Trouvez une <p>Activité avec </p><p class="text-secondary">La Météo</p></h1>
